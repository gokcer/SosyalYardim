...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<SosyalYardimBlazorApplication>();
            builder.Modules
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                ...
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the SosyalYardim.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
